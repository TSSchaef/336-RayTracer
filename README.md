...
--------
### Intro
This ray tracer was originally developed for CS336 (Intro to Computer Graphics). A brief report of the theory/implementation is available in 'CS336 Ray Tracer Report.pdf' (see above).
